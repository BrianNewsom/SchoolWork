...
int main(){
	...
	for (int i = 0; i < iter; ++i)
	{
		...
		//Answer can also be set directly to 0 or 1
	...
	cout <<"Total correct guesses when not changed: "<<correctDoorStay<<endl;
	...
	cout <<"The probablity of choosing the right door when door is changed is: "<< 100*resultChange <<" \%"<<endl<< endl;
