...
public interface LinkedListInterface {
    ...
    */
    ...
    /**
     * Like appendvalue(), but this inserts the number into the list at
     * the given offset. For example, if the list starts as:
     *
     * 10 20 30 40
     *
     * and we insertvalue(2, 5), the resulting list will be:
     *
     * 10 20 5 30 40
     *
    ...
    /**
     *  Same as insertvalue, except the node has been created for us.
     */
